...
--------------------------------------------------------------*/
  function stickyHeader() {
    ...
    var $nestedHeader = $(".cs_mega_wrapper");
    ...
    $window.scroll(function () {
      ...
      if (windowTop === 0) {
          $header.addClass("cs_text_white");
          $nestedHeader.addClass("cs_text_black");
        }else {
        $header.removeClass("cs_text_white");
        $nestedHeader.removeClass("cs_text_black");
      }
